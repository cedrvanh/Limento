  ...
  handleDialogSubmit = () => {
    ...
    switch(this.state.postAction) {
      case POSTACTIONSENUM.DELETE:
        ...
        break;
      case POSTACTIONSENUM.SOFTDELETE:
        url = `/api/v1/categories/${this.state.categoryId}?mode=softdelete`;
        options = {
          method: 'DELETE'
        }
        break;
      case POSTACTIONSENUM.SOFTUNDELETE:
        url = `/api/v1/categories/${this.state.categoryId}?mode=softundelete`;
        options = {
          method: 'DELETE'
        }
        break;
            ...
            <TableBody>
              {categories && categories.map( (category, index) => (
                <TableRow key={category.id}>
                  ...
                  <TableCell>{category.synopsis}</TableCell>
