      ...
      <React.Fragment>
        ...
        <form className={classes.form}>
          ...
          <FormControl margin="normal" required fullWidth>
            ...
            <Input id="name" name="name" value={this.state.name} onChange={this.handleChange} autoComplete="name" autoFocus />
          </FormControl>
          <FormControl margin="normal" required fullWidth>
            <InputLabel htmlFor="city">City</InputLabel>
            <Input name="city" id="city" value={this.state.city} onChange={this.handleChange} autoComplete="city" />
          </FormControl>
          <FormControl margin="normal" required fullWidth>
            <InputLabel htmlFor="street">Street</InputLabel>
            <Input name="street" type="street" id="street" value={this.state.street} onChange={this.handleChange} autoComplete="street" />
          </FormControl>
          <FormControl margin="normal" required fullWidth>
